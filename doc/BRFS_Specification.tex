...
\begin{document}
	...
	\begin{tabular}{|l|l|l|} 
		...
		\hline
		1 & Attribute size in bytes & 0-255  \\
		\hline
	...
	BRFS is a file based filesystem. Regular files and directories are both files. In the end of each file's block, lies a pointer to the next block of the file. This pointer is a linear offset of blocks
	...
	Enumeration of possible file types on a directory, one of:
